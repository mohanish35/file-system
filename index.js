...
console.log(await fileSystem.write('/Heroes/Avengers/Tony Stark.txt', 'I am Iron Man'))
console.log(await fileSystem.read('/Heroes/Avengers/Tony Stark.txt'))
console.log(await fileSystem.write('/Heroes/Avengers/Tony Stark.txt', 'I am Tony Stark'))
console.log(await fileSystem.mtime('/Heroes/Avengers/Tony Stark.txt'))
...
await fileSystem.rename('/Heroes/Avengers', 'Dead Avengers')
